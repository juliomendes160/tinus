    ...
    if (status.isGranted) {
      ...
      if (result != null) {
        ...
        _controller.runJavaScript('''
          alert(window.name);
          alert(window[0].name);
          alert(window[0][0].name);
          alert(window[0][0].document.getElementById('FileStreamTeste').id);
          window[0][0].document.getElementById('FileStreamTeste').value = 100;
          alert( window[0][0].document.getElementById('FileStreamTeste').value);
          var fileInput = window[0][0].document.getElementById('FileStream');
          if (fileInput) {
